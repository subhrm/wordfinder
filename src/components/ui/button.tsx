...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-lg px-8 py-4 text-2xl font-bold shadow-md border border-gray-300 bg-white text-gray-900 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-blue-400 hover:bg-gray-100 active:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        default: "",
